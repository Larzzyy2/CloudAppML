...
install("url");                                                              // 79
install("oauth");                                                            // 80
install("accounts-oauth");                                                   // 81
install("service-configuration");                                            // 82
install("oauth2");                                                           // 83
install("spacebars");                                                        // 84
install("templating-compiler");                                              // 85
install("templating-runtime");                                               // 86
install("templating");                                                       // 87
install("google");                                                           // 88
install("accounts-google");                                                  // 89
install("webapp");                                                           // 90
install("livedata");                                                         // 91
install("hot-code-push");                                                    // 92
install("launch-screen");                                                    // 93
install("ui");                                                               // 94
install("autoupdate");                                                       // 95
                                                                             // 96
///////////////////////////////////////////////////////////////////////////////
