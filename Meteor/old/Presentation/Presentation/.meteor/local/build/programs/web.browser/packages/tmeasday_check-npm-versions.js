...
////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                              //
module.export({checkNpmVersions:function(){return checkNpmVersions}});var semver;module.import('semver',{"default":function(v){semver=v}});var _;module.import('meteor/underscore',{"_":function(v){_=v}});
                                                                                              // 2
                                                                                              //
// Returns:                                                                                   // 4
...
var compatibleVersionIsInstalled = function compatibleVersionIsInstalled(name, range) {       // 8
  try {                                                                                       // 9
    ...
    console.log(e);                                                                           // 17
    // XXX I guess the only error here is that the module doesn't exist?                      // 18
    return false;                                                                             // 19
  }                                                                                           // 20
};                                                                                            // 21
                                                                                              //
var checkNpmVersions = function checkNpmVersions(packages, packageName) {                     // 23
  var failures = {};                                                                          // 24
