...
Template["MeteorToys"] = new Template("Template.MeteorToys", (function() {                                            // 3
  ...
  return [ HTML.Raw("<!-- Meteor Toys Begin -->\n\t"), Blaze.If(function() {                                          // 5
    ...
    return [ "\n\t\t", Blaze.If(function() {                                                                          // 8
      return Spacebars.call(view.lookup("MeteorToysCordova"));                                                        // 9
    }, function() {                                                                                                   // 10
      ...
      return [ " \n\t\t", Blaze.If(function() {                                                                       // 17
        return Spacebars.call(view.lookup("MeteorToys_Pro"));                                                         // 18
      }, function() {                                                                                                 // 19
        return [ "\n\t\t\t\t", Spacebars.include(view.lookupTemplate("MeteorToys_tooltip")), "\n\t\t\t\t", HTML.DIV({
          class: "MeteorToys_orbs MeteorToysReset"                                                                    // 21
        }, "\n\t\t\n\t\t\t\t\t", Blaze.Each(function() {                                                              // 22
          return Spacebars.call(view.lookup("MeteorToy"));                                                            // 23
        }, function() {                                                                                               // 24
          return [ "\n\t\t\t\t\t\t", Blaze._TemplateWith(function() {                                                 // 25
            return {                                                                                                  // 26
              template: Spacebars.call(view.lookup("."))                                                              // 27
            };                                                                                                        // 28
          }, function() {                                                                                             // 29
          ...
          return Spacebars.call(view.lookup("MeteorToy_addon"));                                                      // 35
        }, function() {                                                                                               // 36
          return [ "\n\t\t\t\n\t\t\t\t\t\t\t", Blaze._TemplateWith(function() {                                       // 37
            return {                                                                                                  // 38
              template: Spacebars.call(view.lookup("."))                                                              // 39
            };                                                                                                        // 40
          }, function() {                                                                                             // 41
        ...
        return [ "\n\t\t\t\t", HTML.DIV({                                                                             // 48
          class: "MeteorToys_orbs MeteorToysReset"                                                                    // 49
        }, "\n\t\t\t\t\t", Blaze._TemplateWith(function() {                                                           // 50
          return {                                                                                                    // 51
            template: Spacebars.call(view.lookup("all"))                                                              // 52
          };                                                                                                          // 53
        }, function() {                                                                                               // 54
          ...
          return Spacebars.call(view.lookup("MeteorToy_addon"));                                                      // 59
        }, function() {                                                                                               // 60
          return [ "\n\t\t\t\n\t\t\t\t\t\t\t", Blaze._TemplateWith(function() {                                       // 61
            return {                                                                                                  // 62
              template: Spacebars.call(view.lookup("."))                                                              // 63
            };                                                                                                        // 64
          }, function() {                                                                                             // 65
            return Spacebars.include(function() {                                                                     // 66
              return Spacebars.call(Template.__dynamic);                                                              // 67
            });                                                                                                       // 68
          }), "\n\t\t\t\n\t\t\t\t\t" ];                                                                               // 69
        }), "\n\t\t\t\t"), "\n\t\t\t" ];                                                                              // 70
      }), "\n\n\n\n\t\t\t", Blaze.Each(function() {                                                                   // 71
        return Spacebars.call(view.lookup("MeteorToysPackage"));                                                      // 72
      }, function() {                                                                                                 // 73
        return [ "\n\t\t\t\t", Blaze._TemplateWith(function() {                                                       // 74
          return {                                                                                                    // 75
            template: Spacebars.call(view.lookup("."))                                                                // 76
          };                                                                                                          // 77
        }, function() {                                                                                               // 78
          return Spacebars.include(function() {                                                                       // 79
            return Spacebars.call(Template.__dynamic);                                                                // 80
          });                                                                                                         // 81
        }), "\n\t\t\t" ];                                                                                             // 82
      }), "\n\n\t\t" ];                                                                                               // 83
    }), "\n\t" ];                                                                                                     // 84
    ...
    return [ "\n\t\t", Blaze.If(function() {                                                                          // 86
      return Spacebars.call(view.lookup("MTtoggle"));                                                                 // 87
    }, function() {                                                                                                   // 88
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
                                                                                                                      // 1
Template.__checkName("MeteorToys_notifications");                                                                     // 2
Template["MeteorToys_notifications"] = new Template("Template.MeteorToys_notifications", (function() {                // 3
  var view = this;                                                                                                    // 4
  return Blaze.If(function() {                                                                                        // 5
    return Spacebars.call(view.lookup("notifications_exist"));                                                        // 6
  }, function() {                                                                                                     // 7
    return [ "\n\t", HTML.DIV({                                                                                       // 8
      id: "MeteorToys_notifications",                                                                                 // 9
      class: "MeteorToys_notifications MeteorToys_hide_Notifications",                                                // 10
      ...
      return Spacebars.call(view.lookup("notifications"));                                                            // 13
    }, function() {                                                                                                   // 14
      return [ "\n\t\t\t", Blaze._TemplateWith(function() {                                                           // 15
        return {                                                                                                      // 16
          template: Spacebars.call(view.lookup("type"))                                                               // 17
        };                                                                                                            // 18
      }, function() {                                                                                                 // 19
        return Spacebars.include(function() {                                                                         // 20
          return Spacebars.call(Template.__dynamic);                                                                  // 21
                                                                                                                      ...
                                                                                                                      // 27
Template.__checkName("MeteorToys_notification_counter");                                                              // 28
Template["MeteorToys_notification_counter"] = new Template("Template.MeteorToys_notification_counter", (function() {  // 29
  var view = this;                                                                                                    // 30
  return HTML.DIV({                                                                                                   // 31
    class: "MeteorToys_notification MeteorToys_notification_counter",                                                 // 32
    id: function() {                                                                                                  // 33
      return [ "MeteorToys_", Spacebars.mustache(view.lookup("_id")) ];                                               // 34
    }                                                                                                                 // 35
  }, "\n\t\t", HTML.DIV({                                                                                             // 36
    class: "MeteorToys_notification_symbol"                                                                           // 37
  }, HTML.STRONG(Blaze.View("lookup:data", function() {                                                               // 38
    return Spacebars.mustache(view.lookup("data"));                                                                   // 39
  }))), "\n\t\t", HTML.DIV({                                                                                          // 40
    class: "MeteorToys_notification_text"                                                                             // 41
  }, Blaze.View("lookup:text", function() {                                                                           // 42
    return Spacebars.makeRaw(Spacebars.mustache(view.lookup("text")));                                                // 43
  })), "\n\t");                                                                                                       // 44
}));                                                                                                                  // 45
                                                                                                                      // 46
Template.__checkName("MeteorToys_notification_text");                                                                 // 47
Template["MeteorToys_notification_text"] = new Template("Template.MeteorToys_notification_text", (function() {        // 48
  var view = this;                                                                                                    // 49
  return HTML.DIV({                                                                                                   // 50
    class: "MeteorToys_notification",                                                                                 // 51
    id: function() {                                                                                                  // 52
      return [ "MeteorToys_", Spacebars.mustache(view.lookup("_id")) ];                                               // 53
    }                                                                                                                 // 54
  }, HTML.Raw('\n\t\t<div class="MeteorToys_notification_symbol"><strong></strong></div>\n\t\t'), HTML.DIV({          // 55
    class: "MeteorToys_notification_text"                                                                             // 56
  }, Blaze.View("lookup:text", function() {                                                                           // 57
    return Spacebars.makeRaw(Spacebars.mustache(view.lookup("text")));                                                // 58
  })), "\n\t");                                                                                                       // 59
}));                                                                                                                  // 60
                                                                                                                      // 61
Template.__checkName("MeteorToys_notification_data");                                                                 // 62
Template["MeteorToys_notification_data"] = new Template("Template.MeteorToys_notification_data", (function() {        // 63
  var view = this;                                                                                                    // 64
  return HTML.DIV({                                                                                                   // 65
    class: function() {                                                                                               // 66
      return [ "MeteorToys_notification ", Spacebars.mustache(view.lookup("expanded")) ];                             // 67
    },                                                                                                                // 68
    id: function() {                                                                                                  // 69
      return [ "MeteorToys_", Spacebars.mustache(view.lookup("_id")) ];                                               // 70
    }                                                                                                                 // 71
  }, HTML.Raw('\n\t\t<div class="MeteorToys_notification_symbol">\n\t\t\t<div class="MeteorToys_notification_triangle"></div>\n\t\t</div>\n\t\t'), HTML.DIV({
    class: "MeteorToys_notification_text"                                                                             // 73
  }, Blaze.View("lookup:text", function() {                                                                           // 74
    return Spacebars.makeRaw(Spacebars.mustache(view.lookup("text")));                                                // 75
  })), "\n\t\t", Blaze.If(function() {                                                                                // 76
    return Spacebars.call(view.lookup("lazyload"));                                                                   // 77
  }, function() {                                                                                                     // 78
    return [ HTML.DIV({                                                                                               // 79
      class: "MeteorToys_notification_data"                                                                           // 80
    }, "\n", HTML.PRE(Blaze.View("lookup:data", function() {                                                          // 81
      return Spacebars.makeRaw(Spacebars.mustache(view.lookup("data")));                                              // 82
    })), "\n\t\t"), "\n\t\t" ];                                                                                       // 83
  }), "\n\t");                                                                                                        // 84
}));                                                                                                                  // 85
                                                                                                                      // 86
Template.__checkName("MeteorToys_notification_widget");                                                               // 87
Template["MeteorToys_notification_widget"] = new Template("Template.MeteorToys_notification_widget", (function() {    // 88
  var view = this;                                                                                                    // 89
  return Blaze.If(function() {                                                                                        // 90
    return Spacebars.call(view.lookup("count"));                                                                      // 91
  }, function() {                                                                                                     // 92
    return [ "\n\t", HTML.DIV({                                                                                       // 93
      class: "MeteorToys_notification_widget"                                                                         // 94
    }, "\n\t\t", Blaze.View("lookup:count", function() {                                                              // 95
      return Spacebars.mustache(view.lookup("count"));                                                                // 96
    }), "\n\t"), "\n\t" ];                                                                                            // 97
  });                                                                                                                 // 98
}));                                                                                                                  // 99
                                                                                                                      // 100
...
Template["MeteorToys_basic"] = new Template("Template.MeteorToys_basic", (function() {                                // 3
  ...
  return Blaze._TemplateWith(function() {                                                                             // 5
    ...
    return Spacebars.include(view.lookupTemplate("MeteorToy"), function() {                                           // 10
      return [ "\n\t\t", HTML.DIV({                                                                                   // 11
        class: "MeteorToys_Method_header"                                                                             // 12
      }, "\n\t\t\t", HTML.DIV({                                                                                       // 13
        class: "MeteorToys_name"                                                                                      // 14
      }, HTML.STRONG("Meteor Toys Pro")), "\n\t\t"), "\n\t\t", HTML.DIV({                                             // 15
        style: "padding-left: 8px"                                                                                    // 16
      }, "\n\n\t\t", HTML.FORM("\n\t\t\t", HTML.DIV({                                                                 // 17
        ...
        type: "submit",                                                                                               // 30
        value: "Activate",                                                                                            // 31
        style: "margin-top: -4px; padding-right: 8px; margin-left: -8px; border-right: 8px sold transparent;"         // 32
      }), "\n\n\t\t\t", HTML.Comment(' <div style="position: absolute; bottom: 14px; left: 12px"> '), "\n\t\t\t", HTML.DIV({
        style: "height: 156px"                                                                                        // 34
      }), "\n\t\t\tExperience the next level", HTML.BR(), " of Mongol and JetSetter. ", HTML.BR(), "\n\t\t\t", HTML.A({
        href: "http://bit.ly/1FqdsPM"                                                                                 // 36
      }, "Upgrade to Meteor Toys Pro ", HTML.CharRef({                                                                // 37
        html: "&raquo;",                                                                                              // 38
        str: "»"                                                                                                      // 39
      })), "\n\t\t\t", HTML.Comment(" </div> "), "\n\n\t\t"), "\n\t\t"), "\n\t" ];                                    // 40
    });                                                                                                               // 41
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
                                                                                                                      // 1
Template.__checkName("MeteorToy");                                                                                    // 2
Template["MeteorToy"] = new Template("Template.MeteorToy", (function() {                                              // 3
  var view = this;                                                                                                    // 4
  return HTML.DIV({                                                                                                   // 5
    class: function() {                                                                                               // 6
    ...
    oncontextmenu: "Package['meteortoys:toykit'].MeteorToys.closeToy();return false;"                                 // 12
  }, "\n\t\t", Blaze.If(function() {                                                                                  // 13
    return Spacebars.call(view.lookup("empty"));                                                                      // 14
  }, function() {                                                                                                     // 15
    ...
    return [ "\n\t\t\t", HTML.DIV({                                                                                   // 22
      class: "MeteorToys_icon"                                                                                        // 23
    }), "\n\t\t\t", HTML.DIV({                                                                                        // 24
      class: "MeteorToys_orb_wrapper"                                                                                 // 25
    }, "\n\t\t\t\t", Blaze.If(function() {                                                                            // 26
      return Spacebars.call(view.lookup("load"));                                                                     // 27
    }, function() {                                                                                                   // 28
      return [ "\n\t\t\t\t\t", Blaze._InOuterTemplateScope(view, function() {                                         // 29
        return Spacebars.include(function() {                                                                         // 30
          return Spacebars.call(view.templateContentBlock);                                                           // 31
                                                                                                                      ...
                                                                                                                      // 37
Template.__checkName("MeteorToys_tooltip");                                                                           // 38
Template["MeteorToys_tooltip"] = new Template("Template.MeteorToys_tooltip", (function() {                            // 39
  var view = this;                                                                                                    // 40
  return Blaze.If(function() {                                                                                        // 41
    return Spacebars.call(view.lookup("display"));                                                                    // 42
  }, function() {                                                                                                     // 43
    return [ "\n\t", HTML.DIV({                                                                                       // 44
      class: "MeteorToys_tooltip_wrapper MeteorToys_notification_fadeInUp",                                           // 45
      style: function() {                                                                                             // 46
        return [ "left: ", Spacebars.mustache(view.lookup("position")), "px;" ];                                      // 47
      }                                                                                                               // 48
    }, "\n\t\t", HTML.DIV({                                                                                           // 49
      class: "MeteorToys_tooltip "                                                                                    // 50
    }, "\n\t\t\t", HTML.DIV({                                                                                         // 51
      class: "MeteorToys_tooltip_arrow1"                                                                              // 52
    }), "\n\t\t\t", HTML.DIV({                                                                                        // 53
      class: "MeteorToys_tooltip_arrow2"                                                                              // 54
